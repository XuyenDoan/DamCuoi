...
/**
 * Khối tóm tắt "Giờ Lễ & Địa Điểm" — thay thế hẳn cho dòng ngày cưới +
 * đếm ngược từng nhà trước đây (đã xoá theo yêu cầu, tránh trùng lặp với
 * "Thông tin lễ cưới — Nhà trai/Nhà gái" quản lý riêng ở Admin). Đặt ngay
 * sau Hero (không nhét vào bên trong Hero `min-h-screen` để giữ nguyên
 * thiết kế full-viewport có chủ đích của Hero). Chỉ hiện tóm tắt (giờ + tên
