    ...
    <Transition name="wish-modal">
      ...
      >
        <div
          ...
          class="wish-modal-panel max-h-[85vh] w-full max-w-md overflow-y-auto rounded-xl border border-secondary-light/40 bg-bg p-6 shadow-lg"
        >
...
.wish-modal-enter-active .wish-modal-panel,
.wish-modal-leave-active .wish-modal-panel {
...
.wish-modal-enter-from .wish-modal-panel,
.wish-modal-leave-to .wish-modal-panel {
